...
public partial class Main
{
    ...
    private void LoadJourney()
    {
        ...
        foreach(var (id,line) in JourneyDialogue.Load().Concat(JourneyDialogue.Rooms()).Concat(JourneyDialogue.Archive()))Radio[id]=(line[0]=="ebba"?"RIKSAMIRAL EBBA GRIP":"ANTIKVARIE HEDVIG RÅLAMB",line[1]);
    }
