...
public partial class Main
{
    ...
    {
        LoadWaterArt();_gamlaSlot=false;_observatorySlot=true;_meridianSlot=_uppsalaSlot=_foundrySlot=_mineSlot=_regimentSlot=_doorSlot=_roomsSlot=_portSlot=_atlandSlot=false;
