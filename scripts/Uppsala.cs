...
public sealed partial class Combat
{
    ...
    [JsonIgnore] public string UppsalaGoal=>InGamla?GamlaGoal:InObservatory?ObservatoryGoal:InCabin?CabinGoal:GamlaState.Debriefed?"Nästa etapp · Västra vågen":ObservatoryState.Debriefed?"Till fregatten · färd mot Gamla Uppsala":InMeridian?MeridianGoal:!UppsalaState.ClueRead?"Läs astronomens anvisning":!UppsalaState.Aligned?"Rikta gårdens tre instrument":!UppsalaState.Secured?"Skydda stjärnplattan":!UppsalaState.KeyTaken?"Undersök portens daterade sigill":MeridianState.OrderTaken?(CabinState.Briefed?(ObservatoryState.OriginalTaken?"Återvänd med originalet till Ebba":"Fortsätt till observatoriet"):"Till landgången · möt Ebba"):MeridianState.CourtOpen?"Fortsätt genom porten till klockgången":"Öppna porten med datumavtrycket";
