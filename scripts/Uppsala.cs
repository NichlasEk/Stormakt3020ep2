...
public static class Uppsala
{
    ...
    public static readonly string[] Ids=new[]{Court,Meridian.Clock,Meridian.Hall,Cabin.Room}.Concat(Observatory.Ids).Concat(Gamla.Ids).ToArray();
