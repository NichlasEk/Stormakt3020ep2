...
public partial class Main
{
    ...
    {
        _rescueSlot=false;_saltSlot=false;_westSlot=false;_gamlaSlot=false;_observatorySlot=false;_meridianSlot=false;_uppsalaSlot=false;_shipTime=0;_pendingStoryFilm="";_radioBreath=0;_foundrySlot=false;_mineSlot=false;_regimentSlot=false;
        _doorSlot=false;
        _atlandSlot=true;
