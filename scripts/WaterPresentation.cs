...
public partial class Main
{
    ...
    private Texture2D RoomBackground=>PaintRoom==Observatory.Workshop&&_game.ObservatoryState.CabinetOpened?_workshopEmpty!:Observatory.Known(PaintRoom)?_observatoryArt[PaintRoom]:PaintRoom==Meridian.Hall&&_game.ObservatoryState.EntryOpen?_meridianOpen!:PaintRoom==Cabin.Room?_cabinArt!:_game.InDoorTrial?_doorGround!:PaintRoom==Meridian.Clock?_clockArt!:PaintRoom==Meridian.Hall?_meridianArt!:PaintRoom==Uppsala.Court?(_game.MeridianState.CourtOpen?_uppsalaOpen!:_uppsalaArt!):PaintRoom==Regiment.Quay&&_game.FoundryState.PlateTaken?_quayFrigate!:PaintRoom==Mine.Coolway&&_game.FoundryState.GateOpen?_coolwayOpen!:Mine.Known(PaintRoom)?_mineArt[PaintRoom]:PaintRoom==Regiment.Farled&&_game.MineState.EntranceOpen?_mineFarledOpen!:Regiment.Known(PaintRoom)?_regimentArt[PaintRoom]:PaintRoom switch
