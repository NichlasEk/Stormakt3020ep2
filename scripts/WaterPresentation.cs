...
public partial class Main
{
    ...
    private Texture2D RoomBackground=>_game.InDoorTrial?_doorGround!:PaintRoom==Uppsala.Court?_uppsalaArt!:PaintRoom==Regiment.Quay&&_game.FoundryState.PlateTaken?_quayFrigate!:PaintRoom==Mine.Coolway&&_game.FoundryState.GateOpen?_coolwayOpen!:Mine.Known(PaintRoom)?_mineArt[PaintRoom]:PaintRoom==Regiment.Farled&&_game.MineState.EntranceOpen?_mineFarledOpen!:Regiment.Known(PaintRoom)?_regimentArt[PaintRoom]:PaintRoom switch
