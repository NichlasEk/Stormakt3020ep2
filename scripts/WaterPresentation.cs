...
public partial class Main
{
    ...
    private Texture2D RoomBackground=>_game.InDoorTrial?_doorGround!:Mine.Known(PaintRoom)?_mineArt[PaintRoom]:PaintRoom==Regiment.Farled&&_game.MineState.EntranceOpen?_mineFarledOpen!:Regiment.Known(PaintRoom)?_regimentArt[PaintRoom]:PaintRoom switch
