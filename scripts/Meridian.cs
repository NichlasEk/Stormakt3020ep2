...
public sealed partial class Combat
{
    ...
    [JsonIgnore] public bool InMeridian=>InUppsala&&Rooms!.Current!=Uppsala.Court;
    [JsonIgnore] public string MeridianGoal=>Rooms!.Current==Meridian.Clock?
        ...
        !MeridianState.PlateSet?"Jämför stjärnplåten vid astronomens bord":!MeridianState.WardenDefeated?MeridianState.Exposed>0?"Verket tappar takten · angrip väktaren":"Rikta det rörliga instrumentet · undvik mätlinjen":!MeridianState.OrderTaken?"Undersök förflyttningsordern vid porten":"Ordern är säkrad · återvänd till Ebba";
    ...
    {
        if(!InUppsala)return false;var m=MeridianState;
