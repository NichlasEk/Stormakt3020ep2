...
public static class CabinTests
{
    public static void Run(Action<bool,string> check)
    {
        ...
        try
        {
            g.Rooms!.Rooms.Remove(Cabin.Room);g.Rooms.LayoutVersion=10;Save();check(g.Rooms!.Rooms.Count==23&&g.Health==21&&g.MeridianState.OrderTaken,"Published Meridian endpoint migrates without resetting wounds or story");
