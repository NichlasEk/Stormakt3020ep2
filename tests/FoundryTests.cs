...
public static class FoundryTests
{
    public static void Run(Action<bool,string> check)
    {
        ...
        try
        {
            ...
            check(run.Rooms!.LayoutVersion==14&&run.Rooms.Rooms.Count==33&&!run.Rooms.Rooms[Foundry.Room].Visited&&run.Health==68,"Published mine save gains unopened foundry");
