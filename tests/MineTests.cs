...
public static class MineTests
{
    public static void Run(Action<bool,string> check)
    {
        ...
        try
        {
            ...
            check(g.Rooms!.LayoutVersion==11&&g.Rooms.Rooms.Count==23&&g.Health==73&&g.RegimentState.FarledReached,"Published regiment saves gain unexplored mine without resetting story or health");
